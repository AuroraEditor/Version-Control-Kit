...
//        var args = ["log", commitish]
//
//        if hideWhitespaceInDiff {
//            args.append("-w")
//        }
//        
//        args += ["-m", "-1", "--first-parent", "--patch-with-raw", "-z", "--no-color", "--", file.path]
//
//        switch file.status {
//        case .copiedOrRenamed(let copiedOrRenamedFileStatus):
//            args.append(copiedOrRenamedFileStatus.oldPath)
//        default:
//            print("")
//        }
//
...
//                                        name: #function)
//
//        return try buildDiff(output: result.output, repository: repository, file: file, commitish: commitish)
//    }
    ...
    func parse(text: String) -> IRawDiff {
        ...
        do {
            ...
            do {
                ...
                print("Hunk parser needs to be added")
            }
