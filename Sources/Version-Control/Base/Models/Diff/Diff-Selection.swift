...
public enum DiffSelectionType: String {
...
/// never a match.
public func typeMatchesSelection(selectionType: DiffSelectionType,
...
public class DiffSelection {
    ...
    public func isSelected(lineIndex: Int) -> Bool {
        ...
        if self.defaultSelectionType == .all {
            ...
            print("Unknown base selection type \(self.defaultSelectionType)")
        }
        ...
        if computedSelectionType == .partial {
            ...
            if try typeMatchesSelection(selectionType: self.defaultSelectionType,
                ...
                for i in stride(from: from, to: to, by: 1) {
                    ...
                    if self.isSelected(lineIndex: i) {
